...
await work() // 542ms
\end{lstlisting}
    \cprotect\subcaption{JavaScript awaits all running tasks at the end of their scope (program scope). The execution of the above program takes $\gt 500ms$ because the \code{inner} \Task{} is awaited.}
