...
%% FORMAL syntax (Section 4): \bsfid keywords, application by
...
\newcommand{\cfgRoot}{\begin{tabular}{@{}l@{}}
    $\iid{write-to-log} \triangleq \bsfid{async}\ \bsfid{fn}\ ()\ \to$\\
  $\quad \bsfid{print}\ \text{"A"};$\\
  $\quad\bsfid{await}\ \bsfid{sys-io}(2, ());$\\
  $\quad\bsfid{print}\ \text{"B"}$\\
  \fgap
  $\iid{process-detach} \triangleq \bsfid{async}\ \bsfid{fn}\ ()\ \to$\\
  $\quad\bsfid{spawn}\ \iid{write-to-log}()$\\
  \fgap
  $\mathit{ex2} \triangleq \bsfid{async}\ \bsfid{fn}\ ()\ \to$\\
  $\quad \bsfid{await}\ \iid{process-detach}();$\\
  $\quad \bsfid{await}\ \bsfid{sys-io}(1, ());$\\
  $\quad \bsfid{print}\ \text{"C"}$\\
  \fgap
  $\bsfid{sys-block}(\mathit{ex2}())$\\
  \fgap
...
\newcommand{\cfgSpawnRedex}{\begin{tabular}{@{}l@{}}
  $C[\, \bsfid{spawn}\ \iid{write-to-log}() \,]$\\
  \fgap
  $\mathit{out}$:\,$\varepsilon$
  \end{tabular}}
...
\newcommand{\cfgQueued}{\begin{tabular}{@{}l@{}}
  $C[\, t_{\iid{write-to-log}} \,]$\\
  \fgap
  $Q$: $\bsfid{print}\ \text{"A"};$\\
  \hphantom{$Q$: }$\bsfid{await}\ \bsfid{sys-io}(2, ());$\\
  \hphantom{$Q$: }$\bsfid{print}\ \text{"B"}$\\
  \fgap
  $\mathit{out}$:\,$\varepsilon$
  \end{tabular}}
...
\newcommand{\cfgQueuedTrio}{\begin{tabular}{@{}l@{}}
  $C[\, t_{\iid{write-to-log}};$\\
  \hphantom{$C[\,$}\dimext{$\bsfid{await}\ t_{\iid{write-to-log}}$}$\,]$\\
  \fgap
  $Q$: $\bsfid{print}\ \text{"A"};$\\
  \hphantom{$Q$: }$\bsfid{await}\ \bsfid{sys-io}(2, ());$\\
  \hphantom{$Q$: }$\bsfid{print}\ \text{"B"}$\\
...
\newcommand{\cfgQueuedSwift}{\begin{tabular}{@{}l@{}}
  $C[\, t_{\iid{write-to-log}};$\\
  \hphantom{$C[\,$}\dimdes{$\bsfid{cancel}\ t_{\iid{write-to-log}}$}$;$\\
  \hphantom{$C[\,$}\dimpro{$\bsfid{try}$}\\
  \hphantom{$C[\,$}\quad\dimext{$\bsfid{await}\ t_{\iid{write-to-log}}$} \\
  \hphantom{$C[\,$}\dimpro{$\bsfid{catch\ fn}\ \mathit{e}\,\to\,()$}
  $\,]$\\
  \fgap
  $Q$: $\bsfid{print}\ \text{"A"};$\\
  \hphantom{$Q$: }$\bsfid{await}\ \bsfid{sys-io}(2, ());$\\
...
\newcommand{\cfgLazyCor}{\begin{tabular}{@{}l@{}}
  $C[\, \bsfid{spawn}\ \mathit{coro}_{\iid{write-to-log}} \,]$\\
  \fgap
  $\mathit{out}$:\,$\varepsilon$
  \end{tabular}}
...
\newcommand{\cfgSwiftAbort}{\begin{tabular}{@{}l@{}}
    $C$$[\,$\dimawa{$\bsfid{throw}\ \text{"cancelled"}$}$\,]$\\
  \fgap
  $\mathit{out}$:\,A
  \end{tabular}}
...
\newcommand{\cfgEagerT}{\begin{tabular}{@{}l@{}}
  $C[\, t_{\iid{write-to-log}} \,]$\\
  \fgap
  $T$: $(2,\ \iid{write-to-log},\ \bsfid{print}\ \text{"B"})$\\
  \fgap
  $\mathit{out}$:\,A
  \end{tabular}}
