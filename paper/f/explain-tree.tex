...
\newcommand{\cfgRoot}{\begin{tabular}{@{}l@{}}
  $\mathit{write\textit{-}to\textit{-}log} \triangleq \mathbfsf{async}\ \mathbfsf{fn}\ ()\ \to$\\
  $\quad \mathbfsf{print}\ \text{"A"};$\\
  $\quad\mathbfsf{await}\ \mathbfsf{sys\textbfsf{-}io}(2, ());$\\
  $\quad\mathbfsf{print}\ \text{"B"}$\\
  \fgap
  $\mathit{process\textit{-}detach} \triangleq \mathbfsf{async}\ \mathbfsf{fn}\ ()\ \to$\\
  $\quad\mathbfsf{spawn}\ (\mathit{write\textit{-}to\textit{-}log}())$\\
  \fgap
  $\mathit{ex2} \triangleq \mathbfsf{async}\ \mathbfsf{fn}\ ()\ \to$\\
  $\quad \mathbfsf{await}\ (\mathit{process\textit{-}detach}());$\\
  $\quad \mathbfsf{await}\ \mathbfsf{sys\textbfsf{-}io}(1, ());$\\
  $\quad \mathbfsf{print}\ \text{"C"}$\\
  \fgap
  $\mathbfsf{sys\textbfsf{-}block}(\mathit{ex2}())$\\
  \fgap
...
\newcommand{\cfgSpawnRedex}{\begin{tabular}{@{}l@{}}
  $C[\, \mathbfsf{spawn}\ (\mathit{write\textit{-}to\textit{-}log}()) \,]$\\
  \fgap
  $\mathit{out}$:\,$\varepsilon$
  \end{tabular}}
...
\newcommand{\cfgQueued}{\begin{tabular}{@{}l@{}}
  $C[\, t_{\mathit{write\textit{-}to\textit{-}log}} \,]$\\
  \fgap
  $Q$: $\mathbfsf{print}\ \text{"A"};$\\
  \hphantom{$Q$: }$\mathbfsf{await}\ \mathbfsf{sys\textbfsf{-}io}(2, ());$\\
...
\newcommand{\cfgQueuedTrio}{\begin{tabular}{@{}l@{}}
  $C[\, t_{\mathit{write\textit{-}to\textit{-}log}};$\\
  \hphantom{$C[\,$}\dimext{$\mathbfsf{await}\ t_{\mathit{write\textit{-}to\textit{-}log}}$}$\,]$\\
  \fgap
  $Q$: $\mathbfsf{print}\ \text{"A"};$\\
  \hphantom{$Q$: }$\mathbfsf{await}\ \mathbfsf{sys\textbfsf{-}io}(2, ());$\\
  \hphantom{$Q$: }$\mathbfsf{print}\ \text{"B"}$\\
...
\newcommand{\cfgQueuedSwift}{\begin{tabular}{@{}l@{}}
  $C[\, t_{\mathit{write\textit{-}to\textit{-}log}};$\\
  \hphantom{$C[\,$}\dimdes{$\mathbfsf{cancel}\ t_{\mathit{write\textit{-}to\textit{-}log}}$}$;$\\
  \hphantom{$C[\,$}\dimpro{$\mathbfsf{try}$}\\
  \hphantom{$C[\,$}\quad\dimext{$\mathbfsf{await}\ t_{\mathit{write\textit{-}to\textit{-}log}}$} \\
...
\newcommand{\cfgLazyCor}{\begin{tabular}{@{}l@{}}
  $C[\, \mathbfsf{spawn}\ \mathit{coro}_{\mathit{write\textit{-}to\textit{-}log}} \,]$\\
  \fgap
  $\mathit{out}$:\,$\varepsilon$
  \end{tabular}}
...
\newcommand{\cfgEagerT}{\begin{tabular}{@{}l@{}}
  $C[\, t_{\mathit{write\textit{-}to\textit{-}log}} \,]$\\
  \fgap
  $T$: $(2,\ \mathit{write\textit{-}to\textit{-}log},\ \mathbfsf{print}\ \text{"B"})$\\
  \fgap
  $\mathit{out}$:\,A
  \end{tabular}}
...
\newcommand{\cfgSettled}[1]{\begin{tabular}{@{}l@{}}
  $();$\\
  $\mathbfsf{await}\ \mathbfsf{sys\textbfsf{-}io}(1, ());$\\
...
\noindent
% {\tiny where $C \triangleq [\cdot];\ \mathbfsf{await}\ \mathbfsf{sys\textbfsf{-}io}(1, 0);\ \mathbfsf{print}\ \text{"C"}$ --- the rest of $\mathit{ex2}$; $\mathbfsf{sys\textbfsf{-}block}$ is elided until \semrule{Block-Done} applies}\par\smallskip
...
\begin{tikzpicture}[
  ...
  \node[font=\tiny\rmfamily, text=black!60, anchor=north east, inner sep=0pt]
    ...
    {\begin{tabular}{@{}l@{\quad}l@{}}
        \multicolumn{2}{c}{\textsc{languages}}\\[1.5pt]
        \textbf{\underline{A}}syncio    & S\textbf{\underline{M}}ol\\
        \textbf{\underline{C}}\nolinebreak\hspace{-.05em}\raisebox{.3ex}{{\relsize{-2}\bfseries\#}} & T\textbf{\underline{R}}io\\
        \textbf{\underline{J}}avaScript & \textbf{\underline{S}}wift\\
        To\textbf{\underline{K}}io      & \\
    \end{tabular}};
