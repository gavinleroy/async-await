...
\multicolumn{2}{@{}l@{}}{
  $\begin{array}{l}
  \where\ (\sigma_1, x_{\mathit{task}}) = \sfid{task-alloc}(\sigma_0) \\
    \qquad \cext{\sigma_2 = \sfid{task-add-dependency}(\sigma_2, \ell, x_{\mathit{task}})} \\
  \qquad e_{\mathit{task}} = \bsfid{reset}\ ( \\
  \qquad \qquad \bsfid{try}\ \semmacro{task-set-done}(x_{\mathit{task}}, \mathsf{await}\ v_{\mathit{coro}})\ \bsfid{catch}\ v_{\mathit{err}} \to \semmacro{task-set-failed}(x_{\mathit{task}}, v_{\mathit{err}}) \mathbin{;} \\
