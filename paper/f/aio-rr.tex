...
$\longrightarrow \langle \mathrm{step}(t), \sigma, Q_1, T, P \uplus \{ \langle \ell_{\mathit{waiting}}, \ccan{\mathbfsf{throw\textbfsf{-}in}(\kappa, \text{``cancelled''})} \rangle \circ \epsilon \} \rangle$ & \\
\multicolumn{2}{@{}l@{}}{
  $\begin{array}{l}
