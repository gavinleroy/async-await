...
\multicolumn{2}{@{}l@{}}{
  ...
  \qquad F_{\mathit{new}} = \langle x_{\mathit{task}}, \mathbfsf{reset}\ (e_{\mathit{try}} \mathbin{;} \cext{\mathrm{os\_start\_soon}(\mathrm{task\_get\_dependents}(x_{\mathit{task}}))}) \rangle
  \end{array}$
}
\end{tabular*}
