...
% \begin{figure*}
  ...
  \caption{An example program demonstrating the \Cooperation dimension. A branching execution trace is paired with an indicator of whether an invariant is satisfied. An aware approach allows the canceled task to restore the invariant before proceeding with cancellation, while an unaware approach remains cancelled with the invariant broken.}
  \label{fig:cooperation}
% \end{figure*}
\end{wrapfigure}
