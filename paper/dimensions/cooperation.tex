...
\paragraph{Design rationale.} A benefit of \unaware cancellation is that tasks can be reliably cancelled. The principal case that delays \unaware cancellation is a compute-bound task that does not cooperatively yield to the runtime. With \aware cancellation, functions can either ignore cancellation or fail to opt-in, which we discuss further in \Cref{ssec:designdims:direction}.
