...
\paragraph{Design rationale.} The top-down approach is a straightforward means of propagating cancellation without needing a mechanism like exceptions, which is especially useful for exception-less languages such as Rust. The main limitation of the top-down approach is that it makes custom handling of cancellations --- such as running cleanup code --- difficult.
